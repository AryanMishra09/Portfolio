...
import { ArrowDown, Code, Download, ExternalLink, Monitor, PenTool } from "lucide-react"
...
>
  ...
  <motion.img
    src="/avatar.png"
    alt="Aryan Mishra"
    className="relative w-44 sm:w-56 md:w-72 drop-shadow-2xl mb-6"
...
<div className="absolute bottom-0 inset-x-0 h-32 bg-gradient-to-t from-black/10 via-transparent to-transparent"></div>
</motion.div>
